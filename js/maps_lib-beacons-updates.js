...
var MapsLib = {
  ...
  fusionTableId:      "1YGUGcyYrdEC6TsVxo_Gmkd9ZRnPr2QQunKNATiHf",
  ...
  map_centroid:       new google.maps.LatLng(39.67337, -97.258302), //center that your map defaults to
  ...
  doSearch: function(location) {
    ...
    if (text_search != '') {
      whereClause += " AND 'PID' contains ignoring case '" + text_search + "'";
    }
    var type_column = "'Icon'";
    var tempWhereClause = [];
    if ( $("#cbType1").is(':checked')) tempWhereClause.push("measle_turquoise");
    if ( $("#cbType2").is(':checked')) tempWhereClause.push("small_red");
    if ( $("#cbType3").is(':checked')) tempWhereClause.push("small_purple");
